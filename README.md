...
1. Va sur [railway.app](https://railway.app) → Create project
2. "Deploy from GitHub" → push ce dossier sur GitHub d'abord
   ```bash
...
4. Copie l'URL publique : `https://aurora-pwa-production.up.railway.app`
...
1. Ouvre `https://TON-DOMAINE.railway.app` dans **Safari**
2. Tape l'icône "Partager" (carré avec flèche)
3. "Sur l'écran d'accueil"
4. L'app s'installe comme une vraie app native
5. Lance-la → onglet "Réglages" → "Activer les notifications"
